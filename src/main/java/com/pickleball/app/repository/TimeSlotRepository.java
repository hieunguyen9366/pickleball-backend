...
public interface TimeSlotRepository extends JpaRepository<TimeSlot, Long> {
    ...
    /**
     * Tìm time slots trong khoảng thời gian với PESSIMISTIC LOCK để tránh race condition
     * Sử dụng PESSIMISTIC_WRITE lock để đảm bảo chỉ 1 transaction có thể update cùng lúc
     */
